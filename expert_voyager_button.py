...
class ExpertVoyagerButton:
    def __init__(self, ai_game, msg):
        ...
        self.rect.x = self.screen_rect.center[0] - 88
        self.rect.y = self.screen_rect.center[1] + 120
    ...
    def _prep_msg(self, msg):
        ...
        self.msg_img_rect.y = self.screen_rect.center[1] + 120
